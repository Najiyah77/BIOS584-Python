...
tot_pop = input("Enter the total population: ").strip()

while not tot_pop.isdigit() or int(tot_pop) <= 0: # no zero in denominator
...
while not deaths.isdigit() or int(deaths) <= 0:
    print("Invalid input. Enter a positive whole number with no commas.")
    deaths = input("Enter the number of deaths: ").strip()
...
while not true_pos_cases.isdigit() or int(true_pos_cases) <= 0:
    print("Invalid input. Enter a positive whole number with no commas.")
    true_pos_cases = input("Enter the number of true positive cases: ").strip()
...
while not false_neg_cases.isdigit() or int(false_neg_cases) <= 0:
    print("Invalid input. Enter a positive whole number with no commas.")
    false_neg_cases = input("Enter the number of false negative cases: ").strip()
...
while not false_pos_cases.isdigit() or int(false_pos_cases) <= 0:
    print("Invalid input. Enter a positive whole number with no commas.")
    false_pos_cases = input("Enter the number of false positive cases: ").strip()
...
while not true_neg_cases.isdigit() or int(true_neg_cases) <= 0:
    print("Invalid input. Enter a positive whole number with no commas.")
    true_neg_cases = input("Enter the number of true negative cases: ").strip()
...
prevalence = (reported_cases / tot_pop) * 100
case_fatality_rate = (deaths / reported_cases) * 100
mortality_rate = (deaths / tot_pop) * 100
...
print( # wanted it to be printed all at once. these were
    "----------------------------------------------\n"
    "Epidemiology Report:\n"
    "----------------------------------------------\n"
    f"City: {city}\n"
    f"Disease: {disease}\n"
    f"Population: {tot_pop:,}\n"
